 ...
 */
class tx_sexybookmarks_pagerenderer
{
	public $conf = array();
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/sexybookmarks/lib/class.tx_sexybookmarks_pagerenderer.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/sexybookmarks/lib/class.tx_sexybookmarks_pagerenderer.php']);
}
